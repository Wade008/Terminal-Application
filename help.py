...
def help_doc():
    ...
    while exit != "y":
        ...
        print("- The main menu lists all possible actions. To perform a specific action enter the letter shown inside [ ] at the prompt.\n")
        ...
        print("- This feature is accessed by entering the [e] in the main menu.")
